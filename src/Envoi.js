...
function Envoi( config ) {
  this.channels = {}
  this.configuration = _.extend({}, Envoi.configuration, config || {} )
}


/**
  Configuration for envois.
  @public
  @static
  @type Object
*/
...
*/
Envoi.prototype.subscribe = function( channel, callback, context ) {
...
/**
  ...
  @param {Function} callback The callback to fire
*/
Envoi.prototype.unsubscribe = function( channel, callback ) {
...
/**
  ...
  @returns {Boolean}
*/
Envoi.prototype.publish = function( channel, callback ) {
...
/**
  ...
  @returns Boolean
*/
Envoi.prototype.namespaceMatch = function( targetNs, outerNs ) {
